...
export const metadata = {
  title: "Cookie Policy | PaintIT",
  description: "Cookie Policy for PaintIT visualization platform.",
};
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="mb-8">
          ...
          <p className="text-xs text-stone-500 mt-1 font-mono">
            Last Updated: August 2026 • PaintIT Policy Placeholder
          </p>
        </div>
        ...
        <div className="prose prose-stone max-w-none space-y-6 text-sm text-stone-700 leading-relaxed bg-[#F4F1EA] p-8 rounded-3xl border border-stone-300">
          <section className="space-y-2">
            ...
            <p>
              Cookies are small text files stored on your device that allow PaintIT to remember your active room color preferences and workspace state.
            </p>
          </section>
