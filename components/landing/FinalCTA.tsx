  ...
  return (
    <section className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-neutral-900 text-center">
      <div className="bg-gradient-to-b from-neutral-900/90 via-neutral-950 to-neutral-950 border border-neutral-850 rounded-3xl p-8 sm:p-16 space-y-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#FF8C38]/15 blur-[120px] pointer-events-none rounded-full" />
        ...
        <div className="relative z-10 max-w-3xl mx-auto space-y-6">
          ...
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-orange-200 to-neutral-200">
              Show it.
            </span>
          </h2>
          ...
          <div className="pt-4 flex flex-wrap items-center justify-center gap-4">
            <a
              href="#early-access"
              className="px-8 py-3.5 rounded-xl bg-[#FF8C38] hover:bg-[#FF8C38] text-neutral-950 font-black text-xs sm:text-sm uppercase tracking-wider shadow-xl shadow-orange-500/20 active:scale-95 transition-all"
            >
