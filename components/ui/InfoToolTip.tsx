  ...
  return (
    <div className="inline-block relative ml-1.5 align-middle">
      ...
      <button
        ...
        className="w-3.5 h-3.5 inline-flex items-center justify-center text-[10px] font-black rounded-full bg-neutral-800 hover:bg-neutral-700 text-neutral-400 hover:text-[#FF8C38] transition-colors cursor-pointer"
      >
        i
      </button>
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute left-1/2 -translate-x-1/2 bottom-5 mb-2 w-56 p-3 bg-neutral-900 border border-neutral-800 rounded-xl shadow-2xl z-55 animate-slide-up text-left">
            ...
            <h5 className="text-[11px] font-black text-[#FF8C38] uppercase tracking-wide border-b border-neutral-800/60 pb-1.5 mb-1.5">
              💡 {title}
            </h5>
